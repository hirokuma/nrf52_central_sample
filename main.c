...
#define SCAN_INTERVAL              0x00A0                             /**< Determines scan interval in units of 0.625 millisecond(0.625 * 0xa0 = 100msec). */
#define SCAN_WINDOW                0x0050                             /**< Determines scan window in units of 0.625 millisecond(0.625 * 0x50 = 50msec). */
